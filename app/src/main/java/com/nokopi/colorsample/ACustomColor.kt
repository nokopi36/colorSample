...
class ACustomColor : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        image2Spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener{
            override fun onItemSelected(p0: AdapterView<*>?, p1: View?, position: Int, p3: Long) {
                changeColors.changeColorsWhiteOrBlack(d2, position, imageView2)
            }
            override fun onNothingSelected(p0: AdapterView<*>?) { }
        }
        ...
        image3Spinner.adapter = customDropDownAdapter34567
        ...
        image4Spinner.adapter = customDropDownAdapter34567
        ...
        image5Spinner.adapter = customDropDownAdapter34567
        ...
        image6Spinner.adapter = customDropDownAdapter34567
        ...
        image7Spinner.adapter = customDropDownAdapter34567
        image7Spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener{
            override fun onItemSelected(p0: AdapterView<*>?, p1: View?, position: Int, p3: Long) {
                changeColors.changeLeatherColors(d7, position, imageView7)
            }
            override fun onNothingSelected(p0: AdapterView<*>?) { }
        }
        ...
        image8Spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener{
            override fun onItemSelected(p0: AdapterView<*>?, p1: View?, position: Int, p3: Long) {
                changeColors.changeColorsWhiteOrBlack(d8, position, imageView8)
            }
            override fun onNothingSelected(p0: AdapterView<*>?) { }
        }
        ...
        val image10Spinner: Spinner = findViewById(R.id.image10Spinner)
        val customDropDownAdapter10 = CustomSpinnerAdapter(ChangeColors.stringsColorSpinner, ChangeColors.stringsColorSpinnerString)
        image10Spinner.adapter = customDropDownAdapter10
        image10Spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener{
            override fun onItemSelected(p0: AdapterView<*>?, p1: View?, position: Int, p3: Long) {
                changeColors.changeStringColors(d10, position, imageView10)
            }
            override fun onNothingSelected(p0: AdapterView<*>?) { }
        }
    }
