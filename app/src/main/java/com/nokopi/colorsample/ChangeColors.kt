...
class ChangeColors {
    companion object{
        val leathersColorSpinner = listOf(R.drawable.button_white, R.drawable.button_kikutinashi, R.drawable.button_red, R.drawable.button_hatimitu, R.drawable.button_mumei, R.drawable.button_deeproyalpurple,
            R.drawable.button_midnightblue, R.drawable.button_blue, R.drawable.button_seagreen, R.drawable.button_tetuguro, R.drawable.button_black)
        ...
        val spongesColor = listOf(CustomColor.white, CustomColor.sandybrown, CustomColor.black, CustomColor.orange, CustomColor.pink, CustomColor.zenithblue
        ...
        val buttonsColorSpinner = listOf(R.drawable.button_white, R.drawable.button_kikutinashi, R.drawable.button_red, R.drawable.button_vanilla, R.drawable.button_mumei, R.drawable.button_blue, R.drawable.button_green,
            R.drawable.button_tetuguro, R.drawable.button_black)
        ...
        val plSpongesColor = listOf(CustomColor.white, CustomColor.orange, CustomColor.pink, CustomColor.zenithblue, CustomColor.aquamarine
